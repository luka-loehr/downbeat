    ...
    return (
      <main className="mx-auto flex min-h-full w-full max-w-md flex-col justify-center px-6 py-14 text-center">
        ...
        <div className="rise" style={{ animationDelay: "200ms" }}>
          <button
            onClick={() => void join(deviceName())}
            disabled={joining}
            className="w-full rounded-2xl bg-pulse px-6 py-8 text-base font-bold uppercase tracking-[0.24em] text-void transition-opacity active:opacity-80 disabled:opacity-40"
          >
          ...
          <p className="num mt-5 text-[10px] tracking-[0.22em] text-dim">
            {deviceName().toUpperCase()} · {code}
          </p>
